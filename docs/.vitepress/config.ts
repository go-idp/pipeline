          ...
          '/guide/': [
            {
              ...
              items: [
                ...
                { text: 'Service Deployment', link: '/guide/service-deployment' },
                { text: 'Remote Service Deployment', link: '/guide/service-deployment-remote' },
          ...
          '/zh/guide/': [
            {
              ...
              items: [
                ...
                { text: '服务部署', link: '/zh/guide/service-deployment' },
                { text: '服务部署（远端）', link: '/zh/guide/service-deployment-remote' },
